<template>
    ...
    <section class="px-[176px]">
        <div>
            <img class="rounded-lg" src="~/assets/images/client/categories-image.png" alt="">
        </div>
        <p class="text-2xl pt-8 pb-12">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
            tempor
    ...
    <section class="px-[80px]">
        <div class="flex justify-between items-center gap-6">
            ...
            <div class="grid grid-cols-4 gap-3 justify-center py-6">
                <div>
                    <div class="h-96"><img class="h-full object-cover rounded-2xl" src="~/assets/images/client/client-1.jpeg"
                            alt=""></div>
                    <div class="flex flex-col">
                        <button class="flex items-center gap-2 cursor-pointer">
                            <img src="~/assets/images/icons/stars.svg" alt="">
                            <span class="text-[28px] font-medium capitalize">future</span>
                        </button>
                    </div>
                </div>
                <div>
                    <div class="h-96"><img class="h-full object-cover rounded-2xl" src="~/assets/images/client/client-2.jpeg"
                            alt=""></div>
                    <div class="flex flex-col">
                        <button class="flex items-center gap-2 cursor-pointer">
                            <img src="~/assets/images/icons/stars.svg" alt="">
                ...
                <div>
                    <div class="h-96"><img class="h-full object-cover rounded-2xl" src="~/assets/images/client/client-3.jpeg"
                            alt=""></div>
                    <div class="flex flex-col">
                        <button class="flex items-center gap-2 cursor-pointer">
                            <img src="~/assets/images/icons/stars.svg" alt="">
                ...
                <div>
                    <div class="h-96"><img class="h-full object-cover rounded-2xl" src="~/assets/images/client/client-4.jpeg"
                            alt=""></div>
                    <div class="flex flex-col">
                        <button class="flex items-center gap-2 cursor-pointer">
                            <img src="~/assets/images/icons/stars.svg" alt="">
