    ...
    <div class="sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8">
        <div
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                        ...
                        <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button"
                            ...
                            <span class="hidden lg:flex lg:items-center">
                                <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true">Tom
                                    Cook</span>
                                <svg @click="show = !show" class="ml-2 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor"
                                    aria-hidden="true">
                                    <path fill-rule="evenodd"
              ...
              -->
                        <div v-show="show" class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"
